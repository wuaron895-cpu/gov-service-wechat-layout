...
Use exactly four color roles (see `references/color-slot-model.md`):

- 主题色 brand `#ff6d4d` — **swappable**; section titles (solid bars), accents, card left-borders, Q markers, IP name, links. Structural only.
- 警示红 warn `#ff0000` — **fixed**; ❎ errors, 注意/请注意, legal warnings, fraud alerts.
- 正确蓝 correct `#5f9cef` — **fixed**; ✓ correct conclusions / positive findings (可算, 可认定, 正确办理方式).
